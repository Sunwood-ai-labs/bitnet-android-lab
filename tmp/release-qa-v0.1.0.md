...
- post-release corrections: `refreshed docs/public/releases/release-header-v0.1.0.svg to remove text-overflow risk, then reduced the text density further for readability in narrow renderers, and rewrote the GitHub release body in English after Pages published the updated asset`
...
- blockers:
- waivers:
- post-release verification on 2026-03-25: live asset URL for `release-header-v0.1.0.svg` returned HTTP `200` after the refresh commits, and the GitHub release body was re-read after `gh release edit` to confirm the English rewrite
